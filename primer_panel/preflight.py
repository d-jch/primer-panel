    ...
    *,
    ...
    files = [
        ...
        check_file(
            ...
            common_dbsnp_bed,
            required=False,
            hint="Optional. Download from UCSC: wget https://hgdownload.soe.ucsc.edu/goldenPath/hg38/database/snp151Common.txt.gz && zcat snp151Common.txt.gz | cut -f2,3,4,5 > snp151Common_hg38.bed",
        ),
    ]
